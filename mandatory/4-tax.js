...
function calculateSalesTax( price) {
  var priceSalesTax=price*1.2;
  return priceSalesTax;
}
...
function addTaxAndFormatCurrency(number,price) {
 var addTax= calculateSalesTax( price)+number;
  var FormatCurrency=addTax.toFixed(2)
 return `£ ${ FormatCurrency}`;
}

console.log(addTaxAndFormatCurrency(0,15));
